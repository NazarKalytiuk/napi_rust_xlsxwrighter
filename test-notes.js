...
console.log('Testing Excel Notes feature...');
...
// Save the workbook
console.log('Saving workbook to test-notes.xlsx...');
workbook.save('test-notes.xlsx');

console.log('✓ Workbook saved successfully!');
console.log('');
console.log('Notes have been added to cells with:');
console.log('  - Custom authors');
console.log('  - Custom sizes (width/height)');
console.log('  - Custom background colors');
console.log('  - Visibility settings');
console.log('  - Alt text for accessibility');
console.log('');
console.log('Open test-notes.xlsx in Excel to see the notes!');
console.log('(Hover over cells with red triangles to see notes, or they\'re visible by default)');
